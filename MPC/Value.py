...
class Value:
    ...
    def __pow__(self, other, p = field):
        return Value(self.pow(other.value, p))
    ...
    def pow(self, num, p = field):
        return gmpy2.powmod(self.value, num, p)

    def powinv(self, p = field):
        return Value(gmpy2.invert(self.value, p-1))
